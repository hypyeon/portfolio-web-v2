...
export default function LandingPage() {
  ...
  return (
    <div 
      className="relative h-screen w-screen snap-start flex text-gray-900 font-rock items-center bg-gradient-to-b from-neutral-50 to-transparent to-65% pl-[16vw] pr-0 text-[1.25rem] 
