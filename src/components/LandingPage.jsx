  ...
  return (
    ...
    >
      ...
      <div className="h-screen w-screen xl:text-5xl lg:text-4xl flex text-zinc-600 font-rock justify-start items-center px-[22vw] z-2 relative bg-gradient-to-b from-neutral-50 from-0% to-transparent to-50%">
        ...
        <div className='absolute flex flex-col left-[2.5rem] bottom-[2.5rem] gap-3'>
          <div className='hover:ml-1 hover:duration-200'>
            <a 
        ...
        <div className='absolute rotate-[270deg] top-[50vh] -translate-y-[50%] right-[1.5rem] translate-x-[50%]'>
