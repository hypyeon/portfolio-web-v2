...
export default function PortfolioPage() {
  ...
  return (
    ...
    >
      ...
      <div className={`py-4 rounded-3xl w-[74vw] h-[58vh] relative flex items-center overflow-x-scroll snap-x transition-shadow duration-300 ease-in-out ${ activeButton !== '' ? 'shadow-[inset_0_8px_12px_2px_rgba(0,0,0,0.1)]' : ''}`}>
