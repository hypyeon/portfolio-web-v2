...
export default function Journey() {
  return (
    <div className="flex flex-col items-center">
      <div className="relative flex justify-between desktop:w-[78vw] desktop:mx-[20vw] w-[176vw] mx-[32vw]">
        <div className="absolute desktop:w-[118vw] border-t-4 border-neutral-200 left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] w-[240vw]"></div>
        {events.map((event, index) => (
          ...
          >
            ...
            <div className={`absolute ${event.position === "up" ? "top-8" : "bottom-8"} ${event.order === 1 || event.order === 5 ? "desktop:w-[34vw] w-[64vw]" : "desktop:w-[24vw] w-[54vw]"} bg-gray-800 text-white p-4 rounded-lg shadow-lg text-[0.75rem]`}>
